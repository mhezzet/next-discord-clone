    ...
    <div>
      ...
      <ActionTooltip label='Add a server' side='right' align='center'>
        <button onClick={() => setOpen(true)} className='group flex items-center'>
          <div className='mx-3 flex h-[48px] w-[48px] items-center justify-center rounded-[24px] transition-all group-hover:rounded-[16px] group-hover:bg-[#18181b] dark:bg-neutral-700'>
